...
const UI_TRANSLATIONS = {
  ...
  fr: {
    topBarText: "🚀 Économisez jusqu'à 20% sur tous les achats de céréales en vrac cette semaine ! Utilisez le code FRESH20.",
    searchPlaceholder: "Rechercher de la nourriture, des céréales...",
    searchBtn: "CHERCHER",
    account: "Compte",
    orders: "Commandes",
    cart: "Panier",
    categoriesTitle: "Catégories",
    heroTag: "Offre à durée limitée",
    heroTitle: "Remplissez votre garde-manger avec des produits frais.",
    heroDesc: "Obtenez les meilleurs prix de gros et de détail sur les céréales, les huiles et les aliments emballés, livrés directement à votre porte.",
    heroBtn: "Acheter les offres de la semaine",
    items: "articles",
    addToCartBtn: "Ajouter au panier",
    noProductsFoundTitle: "Aucun produit trouvé",
    noProductsFoundDesc: "Essayez de rechercher autre chose ou parcourez une autre catégorie.",
    cartTitle: "Votre panier",
    cartEmpty: "Votre panier est vide.",
    cartTotal: "Total:",
    proceedCheckout: "Passer à la caisse",
    checkoutSuccess: "Commande passée avec succès, {user} ! Nous vous contacterons bientôt.",
    ...
    login: "Connexion",
    signUp: "S'inscrire",
    switchSignUp: "Vous n'avez pas de compte ? S'inscrire",
    switchLogin: "Vous avez déjà un compte ? Connexion",
    footerAbout: "Votre place de marché numéro un pour les produits d'épicerie frais, les céréales et les produits de première nécessité au Nigeria.",
    footerService: "Service client",
    footerContact: "Contactez-nous",
    footerHelp: "Besoin d'aide avec votre commande ? Contactez-nous directement !",
    recipeTitle: "Comment cuisiner / Idées de recettes",
    nutritionTitle: "Nutrition et bienfaits pour la santé",
    closeBtn: "Fermer",
    toastAdded: "{product} ajouté au panier !",
    currencySymbol: "₦"
  },
  es: {
    topBarText: "🚀 ¡Ahorre hasta un 20% en todas las compras de granos a granel esta semana! Use el código FRESH20.",
    searchPlaceholder: "Buscar comida, comestibles, granos...",
    searchBtn: "BUSCAR",
    account: "Cuenta",
    orders: "Pedidos",
    cart: "Carrito",
    categoriesTitle: "Categorías",
    heroTag: "Oferta por tiempo limitado",
    heroTitle: "Abastézcase de productos frescos.",
    heroDesc: "Obtenga los mejores precios de mayorista y minorista en granos, aceites y alimentos empacados entregados directamente a su puerta.",
    heroBtn: "Comprar ofertas",
    items: "artículos",
    addToCartBtn: "Añadir al carrito",
    noProductsFoundTitle: "No se encontraron productos",
    noProductsFoundDesc: "Intente buscar otra cosa o navegue por otra categoría.",
    cartTitle: "Tu carrito",
    cartEmpty: "Tu carrito está vacío.",
    cartTotal: "Total:",
    proceedCheckout: "Proceder al pago",
    checkoutSuccess: "Pedido realizado con éxito, {user}! Nos pondremos en contacto pronto.",
    ...
    switchLogin: "¿Ya tienes cuenta? Iniciar sesión",
    footerAbout: "Su mercado número uno de alimentos frescos, granos y elementos esenciales diarios en Nigeria.",
    footerService: "Servicio al cliente",
    footerContact: "Contáctenos",
    footerHelp: "¿Necesita ayuda con su pedido? ¡Contáctenos directamente!",
    recipeTitle: "Cómo cocinar / Ideas de recetas",
    nutritionTitle: "Nutrición y beneficios para la salud",
    closeBtn: "Cerrar",
...
const CATEGORIES = [
  { id: 'all', icon: 'fa-solid fa-border-all', names: { en: 'All Products', yo: 'Gbogbo Ojà', ig: 'Ngwa Ahịa Niile', ha: 'Duk Kayayyaki', pid: 'All Market', fr: 'Tous les produits', es: 'Todos los productos' } },
  { id: 'grains', icon: 'fa-solid fa-bowl-rice', names: { en: 'Grains & Tubers', yo: 'Koro & Gbaguda', ig: 'Mkpụrụ & Ji', ha: 'Hatsi & Doya', pid: 'Grains & Yam', fr: 'Céréales et tubercules', es: 'Granos y tubérculos' } },
  { id: 'oils', icon: 'fa-solid fa-bottle-droplet', names: { en: 'Oils & Spices', yo: 'Epo & Olorun', ig: 'Mmanụ & Ngwa Nri', ha: 'Mmai & Kayan Yaji', pid: 'Oils & Spices', fr: 'Huiles et épices', es: 'Aceites y especias' } },
  { id: 'packaged', icon: 'fa-solid fa-box', names: { en: 'Packaged Foods', yo: 'Ounjẹ Ti A Pọn', ig: 'Nri A Nwakọrọ', ha: 'Kayan Abinci a Akwati', pid: 'Packaged Foods', fr: 'Aliments emballés', es: 'Alimentos envasados' } },
  { id: 'beverages', icon: 'fa-solid fa-mug-hot', names: { en: 'Beverages & Dairy', yo: 'Ounjẹ Olomi & Wara', ig: 'Ihe Ọṅụṅụ & Mmiri Ara', ha: 'Abubuwan Sha & Wara', pid: 'Drinks & Milk', fr: 'Boissons et produits laitiers', es: 'Bebidas y lácteos' } },
  { id: 'meat', icon: 'fa-solid fa-drumstick-bite', names: { en: 'Meat & Poultry', yo: 'Eran & Eiye', ig: 'Anụ & Ọkụkọ', ha: 'Nama & Kaji', pid: 'Meat & Chicken', fr: 'Viande et volaille', es: 'Carne y aves' } },
  { id: 'fresh', icon: 'fa-solid fa-leaf', names: { en: 'Fresh Produce', yo: 'Efo & Eso Titun', ig: 'Nri Ọhụrụ', ha: 'Kayan Lambu', pid: 'Fresh Vegetables', fr: 'Produits frais', es: 'Productos frescos' } }
];
